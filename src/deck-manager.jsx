...
function BulkScanModal(p) {
  ...
  /* 이미지 압축: 최대 1000px, JPEG 품질 0.75 → 전송량 대폭 감소 */
  var compressImg = function(file, maxSize, quality) {
    return new Promise(function(res, rej) {
      ...
      r.onload = function(e) {
        ...
        img.onload = function() {
          ...
          res({ src: dataUrl, base64: dataUrl.split(',')[1], mediaType: 'image/jpeg', name: file.name });
        };
  ...
  var readImg = function(file) { return compressImg(file, 1000, 0.75); };
...
function SkillPhotoScan(p) {
  ...
  var onImgChange = function(e) {
    ...
    if (!file) return;
    compressImg(file, 1000, 0.75).then(function(compressed) {
      setImg({ base64: compressed.base64, mediaType: compressed.mediaType, preview: compressed.src });
