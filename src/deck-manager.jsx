...
async function scanLineupScreen(base64, mediaType, role, userId) {
  ...
  var prompt = [
    ...
    '1. 카드 이름 바로 위에 "LIVE V1", "LIVE V2", "LIVE V3" 텍스트가 보이면 → cardType: "라이브"',
    '2. 카드에 "ALL STAR" 영문 텍스트가 있으면 → cardType: "올스타"',
    '   ※ 별 모양(★)은 ALL STAR가 아님! 반드시 영문 글자 ALL STAR 여야 함',
    '3. 카드 이름 위 왼쪽에 빨간색 필기체 "Sign" 글자가 있으면 → cardType: "시그니처"',
    '4. 카드 배경이 파란색/남색 계열이면 → cardType: "국가대표"',
    '5. 카드 이름 아래쪽에 노란색/황금색 장식이 있으면 → cardType: "골든글러브"',
    '6. 선수 이름에 연도 숫자(예: \u201818, \u201824)가 없으면 → cardType: "임팩트"',
    '7. 위 조건 모두 해당 없으면 → cardType: "인식실패"',
    '',
    '=== 중요 규칙 ===',
    '- 라이브 카드: 이름 위에 반드시 "LIVE V숫자" 텍스트 있음. 연도도 반드시 있음.',
    '- 임팩트 카드: 이름에 연도 숫자가 절대 없음. 이름 왼쪽에 종류 텍스트 있음.',
    '- 시그니처 카드: 분홍/마젠타 배경. 이름 위 빨간 필기체 Sign.',
    '- 골든글러브 카드: 황금/황토색 배경. 이름 아래 황금 장식.',
    '',
