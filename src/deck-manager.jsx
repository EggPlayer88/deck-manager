...
async function scanLineupScreen(base64, mediaType, role, userId) {
  ...
  var prompt = [
    ...
    '',
    '=== 카드 종류 판별 규칙 (반드시 이 순서대로 확인) ===',
    '',
    '1. 시그니처: 선수 이름표 바로 위 왼쪽에 빨간색 필기체 "Sign" 로고가 작게 있음.',
    '   → Sign 로고가 보이면 배경색 무관하게 무조건 시그니처.',
    '   → 반드시 Sign 유무를 가장 먼저 확인할 것.',
    '',
    '2. 골든글러브: Sign 로고가 없는 상태에서, 이름표 하단 테두리가 진한 황금색/노란색 장식으로 감싸져 있음.',
    '   → Sign 로고가 없을 때만 골든글러브로 분류.',
    '   → 황금빛 배경 광원 효과와 혼동 금지. 이름표 하단 테두리가 황금색인지 확인.',
    '',
    '3. 라이브: 선수 이름 바로 위 중앙/왼쪽에 V1, V2, V3 사각형 뱃지가 있음.',
    '   → 연도도 반드시 함께 표기됨.',
    '',
    '4. 올스타: 카드에 ALL STAR 영문 텍스트가 있음.',
    '   → 별점(★★★★★)과 혼동 금지. 반드시 영문 텍스트여야 함.',
    '',
    '5. 국가대표: 카드 배경이 파란색/남색 계열.',
    '',
    '6. 임팩트: 선수 이름 옆에 연도 숫자가 아예 없음. 이름 왼쪽에 종류 텍스트 있음.',
    '   → 라이브/올스타는 연도가 반드시 있으므로 혼동 금지.',
    '',
    '7. 인식실패: 위 모든 조건에 해당하지 않는 경우.',
    '',
    '=== 핵심 판별 순서 ===',
    '① Sign 로고 확인 (있으면 → 시그니처)',
    '② 이름표 하단 황금색 테두리 확인 (있으면 → 골든글러브)',
    '③ V1/V2/V3 뱃지 확인 (있으면 → 라이브)',
    '④ ALL STAR 텍스트 확인 (있으면 → 올스타)',
    '⑤ 파란 배경 확인 (있으면 → 국가대표)',
    '⑥ 연도 없음 확인 (없으면 → 임팩트)',
    '⑦ 해당 없음 → 인식실패',
    '',
